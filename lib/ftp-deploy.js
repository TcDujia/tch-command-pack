/**
 * @desc copy from https://github.com/rickbergfalk/ftp-deploy
 * @type {exports}
 */
var fs = require('fs');
            ...
            if (err) {
                ...
                ftpMakeDirectoriesIfNeeded(function (err) {
                    if (err) {
                        ...
                        var i = 0;
                        ftpPut(partialFilePaths.pop(),function(){
                            if(partialFilePaths.length > 0){
                                ftpPut(partialFilePaths.pop(),arguments.callee);
                            }else{
